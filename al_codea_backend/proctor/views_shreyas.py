...
# data="""1. What is the purpose of the `componentDidMount()` method in the context of React?
...
def object_creation(question,options,answer):
    field="python"
    question=question
    option1=options[0],
    option2=options[1],
...
def extractor(onequestion):
    options=[]
    answer=''
    questions=''
    ques=''
    lines = onequestion.split('\n')
    ...
    object_creation(questions,options,answer)




def question_creation(data):
